class UserMailer < ApplicationMailer
  ...
  def facebook_activation(facebook_activation, current_user)
	...
	@url_report =  root_url+"facebooks/"+facebook_activation.facebook.id.to_s+"/facebook_activations/"+facebook_activation.id.to_s+"/report_as_abusive?token="+facebook_activation.token
